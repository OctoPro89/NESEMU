...
SET linkerFlags= -L"C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64" -L"C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/ucrt/x64" -luser32 -lOpengl32 -lGdi32 -lOle32
